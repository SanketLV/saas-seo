...
import { BarChart3, FileText, Loader2, Plus, Sparkles } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1 relative">
                    ...
                    <Input
                      ...
                      className="pl-14 h-14 text-base border-2 border-blue-200 dark:border-blue-800 focus:border-blue-500 dark:focus:border-blue-400 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm w-full"
                      disabled={isLoading}
                    />
                  </div>
          ...
          <Card className="border-0 shadow-lg bg-card/50 backdrop-blur-sm">
            ...
            <CardContent>
              <Authenticated>{/* <ReportsTable /> */}</Authenticated>
              <AuthLoading>
